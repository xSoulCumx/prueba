...
use App\Models\Maintenanceegresos;
use App\Library\DataHelpers;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 

class MaintenanceegresosController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'maintenanceegresos';
	static $per_page	= '10';
	
	public function __construct() 
	{
		parent::__construct();
		$this->model = new Maintenanceegresos();
		...
		$this->data = array(
			...
			'pageModule'		=> 'maintenanceegresos',
			'pageUrl'			=>  url('maintenanceegresos'),
	...
	public function index()
	{
		...
		$this->data['setting'] 		= $this->info['setting'];
		return view('maintenanceegresos.index',$this->data);
	}
