...
<div class="">
	...
	<div id="estationsView"></div>	
	<div id="estationsGrid">
		@include( $pageModule.'/toolbar')
		

		<div class="table-responsive">			
			<table id="estationsTable" class="display table table-hover" cellspacing="0" width="100%">
		        <thead>
		            <tr>
		            	<th>ID</th>	
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#estationsTable tbody').on('click', 'td.details-control', function () {
	        ...
	        if ( row.child.isShown() ) {
	            ...
	            tr.addClass('shown');
	            $.get('{{ url("estations/")}}/'+id , function(callback){
	            	$('#'+id).html(callback);
	            	$('#'+id).addClass('data');
	            })
	    ...
	    $('#estationsTable').Sdtable({
	    	tableId : '#estations',
	    	table   : table,
	    	action  : '{{ url("estations")}}' 
	    });
