...
<div class="">
	...
	<div id="imagenologiaView"></div>	
	<div id="imagenologiaGrid">
		@include( $pageModule.'/toolbar')
		

		<div class="table-responsive">			
			<table id="imagenologiaTable" class="display table table-hover" cellspacing="0" width="100%">
		        <thead>
		            <tr>
		            	<th>ID</th>	
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#imagenologiaTable tbody').on('click', 'td.details-control', function () {
	        ...
	        if ( row.child.isShown() ) {
	            ...
	            tr.addClass('shown');
	            $.get('{{ url("imagenologia/")}}/'+id , function(callback){
	            	$('#'+id).html(callback);
	            	$('#'+id).addClass('data');
	            })
	    ...
	    $('#imagenologiaTable').Sdtable({
	    	tableId : '#imagenologia',
	    	table   : table,
	    	action  : '{{ url("imagenologia")}}' 
	    });
