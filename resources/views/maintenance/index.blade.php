...
<div class="">
	...
	<div id="maintenanceView"></div>	
	<div id="maintenanceGrid">
		@include( $pageModule.'/toolbar')
		

		<div class="table-responsive">			
			<table id="maintenanceTable" class="display table table-hover" cellspacing="0" width="100%">
		        <thead>
		            <tr>
		            	<th>ID</th>	
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#maintenanceTable tbody').on('click', 'td.details-control', function () {
	        ...
	        if ( row.child.isShown() ) {
	            ...
	            tr.addClass('shown');
	            $.get('{{ url("maintenance/")}}/'+id , function(callback){
	            	$('#'+id).html(callback);
	            	$('#'+id).addClass('data');
	            })
