...
<div class="">
	...
	<div id="ubicationsView"></div>	
	<div id="ubicationsGrid">
		@include( $pageModule.'/toolbar')
		

		<div class="table-responsive">			
			<table id="ubicationsTable" class="display table table-hover" cellspacing="0" width="100%">
		        <thead>
		            <tr>
		            	<th>ID</th>	
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#ubicationsTable tbody').on('click', 'td.details-control', function () {
	        ...
	        if ( row.child.isShown() ) {
	            ...
	            tr.addClass('shown');
	            $.get('{{ url("ubications/")}}/'+id , function(callback){
	            	$('#'+id).html(callback);
	            	$('#'+id).addClass('data');
	            })
	    ...
	    $('#ubicationsTable').Sdtable({
	    	tableId : '#ubications',
	    	table   : table,
	    	action  : '{{ url("ubications")}}' 
	    });
